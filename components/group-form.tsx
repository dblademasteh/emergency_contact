    ...
    >
      ...
      >
        <div className="mb-5 flex items-center justify-between">
          ...
          {initial && (
            <span className="inline-flex items-center gap-1.5 rounded-full bg-slate-100 px-2.5 py-1 text-center font-mono text-[11px] text-slate-500 dark:bg-slate-800 dark:text-slate-400">
              ID: {initial.id}
            </span>
          )}
          <button
